...
res %>% ggplot(aes(coef, var)) + geom_point() + 
  geom_errorbarh(aes(xmin=lb, xmax=ub, height=0.3)) + 
  geom_vline(aes(xintercept=0)) + 
  scale_x_continuous("Relative risk of SARS-CoV-2 infection\nin primary resident", expand = c(0.05, 0)) + 
