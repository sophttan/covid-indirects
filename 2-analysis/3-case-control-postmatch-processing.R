...
matched <- read_csv("D:/CCHCS_premium/st/indirects/matched_building_0-6days-12matching-061324.csv") 
...
write_csv(matched_infvacc_roommate, "D:/CCHCS_premium/st/indirects/case_control_postmatchprocessing_0-6day_061324.csv")
