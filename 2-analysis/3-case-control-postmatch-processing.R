...
matched <- read_csv("D:/CCHCS_premium/st/indirects/matched_building_3_7days-11matching-072224.csv") 
...
write_csv(matched_infvacc_roommate, "D:/CCHCS_premium/st/indirects/case_control_postmatchprocessing_11match_072224.csv")
