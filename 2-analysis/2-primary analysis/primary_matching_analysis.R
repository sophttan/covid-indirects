...
inf_omicron_subset
write_csv(inf_omicron_subset, "unmatched_all_covariates100722.csv")
...
final
final %>% write_csv("matched_data_ps100722.csv")
...
ggsave(p, filename="days_contact_a2.jpg", width=6, height=4)
